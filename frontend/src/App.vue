				...
				<div class="flex justify-between h-16">
					<div class="flex items-center">
						...
						<div class="hidden sm:ml-8 sm:flex sm:space-x-8">
							...
							<router-link to="/diary" class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium h-full transition-colors no-underline" :class="$route.path.startsWith('/diary') ? 'border-brand-500 text-gray-900' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700'">
								<i class="bi bi-journal-text mr-2"></i> 旅行日记
							</router-link>
