...
def run_migration():
    ...
    try:
        with conn.cursor() as cursor:
            ...
            if 'create_time' in existing_columns and 'created_at' not in existing_columns:
            ...
            elif 'created_at' not in existing_columns and 'create_time' not in existing_columns:
            ...
            for row in cursor.fetchall():
                print(f"  {row['Field']:20} {row['Type']:30} {row['Null']:5} {row['Default']}")
